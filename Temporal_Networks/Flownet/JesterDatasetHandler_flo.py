...
def create_oflow_stack(seq):
	...
	oflow_stack = np.zeros(shape=(len(seq),100,150))
	...
	for i in range(len(seq)):
		...
		of_img = resize_image(of_img, 100, 150)
...
def make_list_of_seqs(ifile,seq_size):
	...
	for line in infile:
	    ...
	    path = path.replace("20bn-jester-v1","20bn-jester-v1-alt-10class-oflow-farneback-6FPS-scaled16-150x100")
